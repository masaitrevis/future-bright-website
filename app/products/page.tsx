    ...
    <div className="pt-20">
      ...
      <section className="relative py-20 md:py-28 bg-navy-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="https://selar.com/m/bright-academy1" className="inline-flex items-center gap-2 text-gold-600 hover:text-gold-700 font-semibold">
            Access our books via this link <ArrowRight size={16} />
          </a>
        </div>
      </section>
